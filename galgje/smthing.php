...
<body>
    ...
    <?php
    $aantalfouten = 0;
    /* Gekozen woord wordt bekeken en ingesteld voor het spel */
    ...
    $gewonnen = true;
    /*Hier wordt gekeken of het woord goed is of niet. */
    ...
    if ($verloren) {
        echo "<h1 class='Verloren'>Verloren</h1>";
    }
    ?>
    ...
    <div class="fout">
        <?php
        if ($aantalfouten === 0) {
            echo ('<img id="dood" src="img/fout0.png">');
        }
        if ($aantalfouten === 1) {
            echo ('<img id="dood" src="img/fout1.png">');
        }
        if ($aantalfouten === 2) {
            echo ('<img id="dood" src="img/fout2.png">');
        }
        if ($aantalfouten === 3) {
            echo ('<img id="dood" src="img/fout3.png">');
        }
        if ($aantalfouten === 4) {
            echo ('<img id="dood" src="img/fout4.png">');
        }
        if ($aantalfouten === 5) {
            echo ('<img id="dood" src="img/fout5.png">');
        }
        if ($aantalfouten === 6) {
            echo ('<img id="dood" src="img/fout6.png">');
        }
        if ($aantalfouten === 7) {
            echo ('<img id="dood" src="img/fout7.png">');
        }
        if ($aantalfouten === 8) {
            echo ('<img id="dood" src="img/fout8.png">');
        }
        if ($aantalfouten === 9) {
            echo ('<img id="dood" src="img/fout9.png">');
        }
        if ($aantalfouten === 10) {
            echo ('<img id="dood" src="img/END.png">');
        }
        ?>
    </div>
</body>
